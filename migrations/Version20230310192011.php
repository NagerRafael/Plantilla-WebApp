 ...
 */
final class Version20230310192011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario ADD id INT NOT NULL');
        $this->addSql('ALTER TABLE usuario ADD password VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE usuario DROP id_usuario');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario ADD id_usuario SERIAL NOT NULL');
        $this->addSql('ALTER TABLE usuario ADD clave VARCHAR(100) NOT NULL');
        $this->addSql('ALTER TABLE usuario DROP id');
